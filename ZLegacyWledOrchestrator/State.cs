...
namespace WledOrchestrator
{
    ...
    public partial class LedState
    {
        public static LedState FromJson(string json) => JsonConvert.DeserializeObject<LedState>(json, WledOrchestrator.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this LedState self) => JsonConvert.SerializeObject(self, WledOrchestrator.Converter.Settings);
    }
